...
<?php 
    ...
    $link = array("home", "#", "#");
    $nama = array("$nama_blok", "Monitoring", "Pengaturan");
    $icon = array("fa fa-building","fa fa-sitemap", "fa fa-wrench");
    for ($i=0; $i <= count($link)-1 ; $i++) { 
      ...
      if ($nama[$i] === "Monitoring") { // Isi link dropdown
        ...
        <li>
            <a class='active' href='./add_stasiun'>Add Location</a>
        </li>
        <li>
                ...
                if ($conn->query("SELECT*FROM client")->num_rows!==0) {
                  ...
                  while ($blok=$query_blok->fetch_assoc()) {
                    ...
                    if ($cek!==0) {
                      ...
                      echo "<li>
                              <a class='active' href='./stasiun&id=$id_blok'><span class='fa fa-building'></span> $name_blok</a>
                              </li>";
                              //tidak terpakais
                        }
                      }
