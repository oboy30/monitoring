...
$limit = 20; // Jumlah ip yang akan ditampilkan per-halaman
$start = 1;
$slice = 9;
...
$q = "SELECT * FROM client WHERE id_blok='$id_st' ORDER BY status_client DESC LIMIT $limitvalue, $limit";
...
if ($cek_page->num_rows != 0) {
    ...
    $sql_cek_row = "SELECT*FROM client WHERE id_blok='$id_st' ORDER BY status_client DESC";
