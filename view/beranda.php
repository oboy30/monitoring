<?php 
    ...
    //$id_blok = $d_blok['id_blok']; 
    $name_st = $d_blok['name_blok']; 
    extract($d_blok); 
?>
...
<div class="tab-content">
  ...
  <div class="tab-pane" id="stasiun-info">
    ...
    <div class="panel-body">
        <ul>
            <li>Nama Lokasi : <strong><?php echo $name_blok; ?></strong></li>
            <li>Lokasi : <strong><?php echo $add_blok; ?></strong></li>
            <li>Telp : <strong>+<?php echo $telp_blok; ?></strong></li>
            <li>Jumlah Devices : <strong><?php echo $total_pc; ?> PC</strong></li>
        </ul>
    </div>
  </div><!-- /.tab-pane -->
...
$(document).ready(function() {
    ...
    var interval = setInterval(function() {
        $.ajax({
             url: 'view/pingger/ping.php?id=<?php echo $id_blok; if (isset($pn)) { echo $pn_link;}; ?>',
