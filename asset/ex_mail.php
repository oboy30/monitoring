...
function sendMail($x) {     
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'unicorne1315@gmail.com'; // Email anda disini
    $mail->Password = 'Hercules12345678*'; // Katasandi email anda
    $mail->SMTPSecure = 'tls';
     
    $mail->From = 'unicorne1315@gmail.com'; // Email disamakan saja
    $mail->FromName = 'Monitoring ITCN3';
    $mail->addAddress('rezabank3299@gmail.com', 'Reza'); // Target email
     
    $mail->addReplyTo('unicorne1315@gmail.com', 'Monitoring ITCN3'); // isi saja sama seperti email yg anda gunakan untuk mengirim
